...
<div class="wrap">
  <div class="accordion_section advance_serach_sec wpas_search">
    <h3 class="mb_0"><?php echo esc_attr__( get_admin_page_title(), $this->plugin_text_domain ); ?></h3>
    <br/>
    <div class="imp_link">
